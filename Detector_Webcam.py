import os
import sys
from extract_video import video_fun
#from extract_frame_from_webcam import video_to_frame
...
# Code written here for extract video frame form webcam call video_fun() function from extract_video python file
# Change code in the extract_frame_from_webcam.py file cv2.VideoCapture(0)
# video_fun()
# video_to_frame()
...
import random
from read_data_test import email_result
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="*",
        default=[],
        help="Specify list of file types to include. Default is --file_types .jpg .jpeg .png .mp4 .avi",
    )
    ...
    # This is for videos
    # For webcam detection please keep one video file inside the Test_Data folder otherwise set the input_video_paths atleast one value
